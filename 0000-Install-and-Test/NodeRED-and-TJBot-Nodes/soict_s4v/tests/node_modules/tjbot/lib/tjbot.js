...
const {exec} = require("child_process");  //TienND: for dummy led NeoPixel function
...
TJBot.prototype.shine = function(color) {
    ...
    var brg = '0x' + rgb[5] + rgb[6] + rgb[1] + rgb[2] + rgb[3] + rgb[4];
//#region   
    //TienND: for dummy led NeoPixel function
    exec("sudo ./ws2811_1led -t " + brg, (error, stdout, stderr) => {
        if (error) {
